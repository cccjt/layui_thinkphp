...
;(function($, window, document, undefined) {    
    ...
    Drag.prototype = {
        ...
        handle: function() {  
            ...
            // 拖动时禁止选择文本    
            $('<style>.DR_select{-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}.DR_maxIndex{z-index:99999}.DR_fixed{position:absolute !important;}.DR_holder{display:inline-block;background:#eee;outline:2px dashed #ddd;vertical-align:middle;}.DR_mid{vertical-align:middle;}</style>').appendTo('head');   
            ...
            $(document).on('mousedown.DR', This.options.childClass, function(e) { 
                ...
                $(document).on('mousemove.DR', function(e) {  
                    ...
                    var diffX = mouseX - stmouseX,    
                        diffY = mouseY - stmouseY,    
                        maxW = $('[DR_move]').parent().width();    
                        maxH = $('[DR_move]').parent().height();    
